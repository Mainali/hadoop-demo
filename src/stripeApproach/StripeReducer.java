...
public class StripeReducer extends Reducer<Text, MapWritable, Text, MapWritableExtended> {
	
	protected void reduce(Text item, Iterable<MapWritable> values, Reducer<Text, MapWritable, Text, MapWritableExtended>.Context context)
		...
		MapWritableExtended finalMap = new MapWritableExtended();
